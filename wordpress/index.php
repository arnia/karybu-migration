<?php
    ...
    $division = 1;
    if (isset($_POST['division'])) $division = (int)($_POST['division']);
    if (isset($_POST['exclude_attach'])) $exclude_attach = $_POST['exclude_attach'];
...
<body>
    ...
    <form action="./index.php" method="post">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="path" value="<?php if (isset($path)) echo $path?>" class="input_text" /><input type="submit" class="input_submit"value="Submit path" />
            </li>
        </ul>
    </form>
    ...
    <input type="hidden" name="target_module" value="<?php if (isset($target_module)) echo $target_module?>" />
    <input type="hidden" name="module_id" value="<?php if (isset($module_id)) echo $module_id?>" />
        ...
        <ul>
            ...
            <?php if(isset($target_module) && $target_module == "module") {?>
            <li>
        ...
        <?php
            ...
            for($i=0;$i<$division;$i++) {
                ...
                $url = sprintf("%s/export.php?filename=%s&amp;path=%s&amp;start=%d&amp;limit_count=%d&amp;exclude_attach=%s", $real_path, urlencode($filename), urlencode($path), $start, $division_cnt, isset($exclude_attach) ? $exclude_attach : 0);
        ?>
            <li>
